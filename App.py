...
class App:
    def __init__(self, master, graph):
        ...
        form_frame.columnconfigure(0, weight=1, minsize=350)
        form_frame.columnconfigure(1, weight=1, minsize=350)
        form_frame.columnconfigure(2, weight=1, minsize=350)
        ...
        left_frame.configure(height=frame_height, width=frame_width)
        ...
        self.delete_entry.grid(row=1, column=1, padx=5)
        ...
        mid_frame.grid(row=0, column=1, sticky="nsew", padx=(0, 20))
        mid_frame.configure(height=frame_height, width=frame_width)
        mid_frame.grid_propagate(False)

        tk.Label(mid_frame, text="Połącz:").grid(row=0, column=0, sticky='w')
        self.edge_entry1 = tk.Entry(mid_frame, width=15)
        self.edge_entry1.grid(row=0, column=1, padx=5)

        tk.Label(mid_frame, text="z:").grid(row=1, column=0, sticky='w')
        self.edge_entry2 = tk.Entry(mid_frame, width=15)
        self.edge_entry2.grid(row=1, column=1, padx=5)

        tk.Label(mid_frame, text="Waga:").grid(row=0, column=2, sticky='w')
        ...
        path_btn.grid(row=1, column=0, padx=10)

        self.path_label = tk.Label(right_frame, text="", fg="green", font=("Arial", 10, "italic"))
        self.path_label.grid(row=2, column=0, columnspan=5)
