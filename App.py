...
class App:
    def __init__(self, master, graph):
        ...
        self.edge_entry2.grid(row=1, column=1, padx=5 , pady=(10, 0))
        ...
        edge_btn.grid(row=1, column=3, padx=10, pady=(10, 0))
        ...
        self.start_entry = tk.Entry(right_frame, width=5)
        self.start_entry.grid(row=0, column=1, padx=5)

        tk.Label(right_frame, text="Koniec:").grid(row=0, column=2)
        self.end_entry = tk.Entry(right_frame, width=5)
